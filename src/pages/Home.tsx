    ...
    <>
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="https://cdn.pixabay.com/vimeo/733923232/brain-210634.mp4?width=1280&hash=e830e8a9a0ec0bad9e27661b2bd0df1c523e7806" type="video/mp4" />
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
              ...
              <Link to="/contact" className="px-6 py-3 rounded-full border-2 border-white/20 text-white font-medium transition-all hover:border-white/40 hover:bg-white/5 hover:scale-105 focus:outline-none">
                Get in Touch
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gradient">Pushing the Boundaries of AI</h2>
            <p className="text-lg text-white/70">
              At DATAi2i, we blend cutting-edge AI technology with industrial expertise to solve complex challenges and drive innovation across sectors.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="glass-card p-6 flex flex-col items-center text-center">
              ...
              <p className="text-white/70">
                Developing AI solutions that adapt to your unique business challenges and opportunities.
              </p>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col items-center text-center">
              ...
              <p className="text-white/70">
                Continuously advancing our AI capabilities through rigorous research and development.
              </p>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col items-center text-center">
              ...
              <p className="text-white/70">
                Seamlessly integrating AI capabilities into existing industrial processes and systems.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-dark/60">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gradient">Our Core Services</h2>
            <p className="text-lg text-white/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="glass-card p-6 hover:-translate-y-2">
              ...
              <Link to="/services" className="text-secondary font-medium hover:text-secondary/80 transition-colors inline-flex items-center">
                Learn More
            ...
            <div className="glass-card p-6 hover:-translate-y-2">
              ...
              <p className="text-white/70 mb-4">
                Intelligent virtual assistants that enhance customer experience and operational efficiency.
              </p>
              <Link to="/services" className="text-secondary font-medium hover:text-secondary/80 transition-colors inline-flex items-center">
                Learn More
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="glass-panel p-10 md:p-16 rounded-2xl max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
              Partner with us to leverage the power of AI and drive your business into the future of technology.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link to="/contact" className="glow-button">
                Contact Us Today
              </Link>
              <Link to="/about" className="px-6 py-3 rounded-full border-2 border-white/20 text-white font-medium transition-all hover:border-white/40 hover:bg-white/5 hover:scale-105 focus:outline-none">
                About Our Team
              </Link>
            </div>
          </div>
